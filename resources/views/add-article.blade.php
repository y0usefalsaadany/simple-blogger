...
<html lang="en">
    <head>
        ...
        <!-- Our Title Page -->
        <title> Add Article Bloger </title>
        <!-- Our Icon Page -->
    ...
    <body>
        ...
        <section class="nav">
            <nav class="container">
                ...
                <ul class="links">
                    ...
                    <li>
                        <a href="./add-article.html" class="active"> <i class="fas fa-project-diagram"></i> Add Article </a>
                    </li>
                </ul>
            </nav>
        </section>
        ...
        <!-- Start About Section -->
        <section class="addArt section-pd">
            <div class="container">
                @if (session()->has('message'))
                    <div class="headeing">{{session('message')}}</div>
                @endif
                <div class="headeing">
                    <h3>Add-Article</h3>
                    <h3>Add-Article</h3>
                ...
                <form action="/store" method="post" enctype="multipart/form-data">
                    @csrf
                    <input class="alli title" type="text" name="title" placeholder="Article Title" required>
                    <div class="file-upload-wrapper" data-text="Select Your File !">
                        <input type="file" name="image" class="file-upload-field" value="">
                    </div>
                    <textarea class="alli content" name="content" placeholder="Article Content" required></textarea>
